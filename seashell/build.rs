...
const STYLE_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/src/style");
const STYLE_MAIN: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/src/style/main.scss");
...
fn main() {
    ...
    let out_dir = std::env::var("OUT_DIR").expect("Variable OUT_DIR not set");
